...
class TestCite2UrnManipGetCollectionVersion {
  ...
  void testGetNotionalCollection(){
   ...
   Cite2Urn rangeNot5 = new Cite2Urn("urn:cite2:hmt:vaimg:")
	 ...
	 assert range1.getCollectionVersion() == null
	 assert range2.getCollectionVersion() == "rel1"
	 assert range3.getCollectionVersion() == "rel1"
	 assert range4.getCollectionVersion() == "rel1"
	 assert range5.getCollectionVersion() == "rel1"
	 assert range6.getCollectionVersion() == "rel1"
	 assert rangeNot1.getCollectionVersion() == null
	 assert rangeNot2.getCollectionVersion() == "rel1" 
	 assert rangeNot3.getCollectionVersion() == "rel1"
	 assert rangeNot4.getCollectionVersion() == "rel1"
	 assert rangeNot5.getCollectionVersion() == null
