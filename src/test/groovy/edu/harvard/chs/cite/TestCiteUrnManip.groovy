...
class TestCiteUrnManip {
  ...
  void testGetObjectComponent(){
   ...
   assert    range1.getObjectComponent() == "vaimg.VA012RN_0013.v1-VA024RN_0025.v1"
  ...
  void testGetObjectWithoutCollection(){
   ...
   assert notRange4.getObjectWithoutCollection() == "VA012RN_0013@0.12,0.12,0.12,0.12"
   assert    range1.getObjectWithoutCollection() == ""
   assert    range2.getObjectWithoutCollection() == ""
   assert    range3.getObjectWithoutCollection() == ""
   assert    range4.getObjectWithoutCollection() == ""
