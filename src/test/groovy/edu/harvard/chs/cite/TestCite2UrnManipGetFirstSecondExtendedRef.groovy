...
class TestCite2UrnManipGetFirstSecondExtendedRef {

  @Test
  void testGetFirstExtendedRef(){
   ...
   Cite2Urn rangeNot5 = new Cite2Urn("urn:cite2:hmt:vaimg:")
	 ...
	 assert range3.getFirstExtended() == null
	 assert range4.getFirstExtended() == "1,1,1,1"
	 assert range5.getFirstExtended() == "1,1,1,1"
	 assert range6.getFirstExtended() == null
	 assert rangeNot1.getFirstExtended() == null
	 assert rangeNot2.getFirstExtended() == null
	 assert rangeNot3.getFirstExtended() == null
	 assert rangeNot4.getFirstExtended() == null
	 assert rangeNot5.getFirstExtended() == null

  }

  @Test
  void testGetSecondExtendedRef(){
   ...
   Cite2Urn rangeNot5 = new Cite2Urn("urn:cite2:hmt:vaimg:")
	 ...
	 assert range2.getSecondExtended() == null
	 assert range3.getSecondExtended() == null
	 assert range4.getSecondExtended() == "2,2,2,2"
	 assert range5.getSecondExtended() == null
	 assert range6.getSecondExtended() == "2,2,2,2"
	 assert rangeNot1.getSecondExtended() == null
	 assert rangeNot2.getSecondExtended() == null
	 assert rangeNot3.getSecondExtended() == null
	 assert rangeNot4.getSecondExtended() == null
	 assert rangeNot5.getSecondExtended() == null
