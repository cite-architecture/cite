...
class TestCite2UrnManipGetObjectComponent {
  ...
  void testGetObjectComponent(){
   ...
   Cite2Urn rangeNot5 = new Cite2Urn("urn:cite2:hmt:vaimg:")
	 ...
	 assert range1.getObjectComponent() == "VA012RN_0013-VA024RN_0025"
	 assert range2.getObjectComponent() == "VA012RN_0013-VA024RN_0025"
	 assert range3.getObjectComponent() == "VA012RN_0013-VA024RN_0025"
	 assert range4.getObjectComponent() == "VA012RN_0013@1,1,1,1-VA024RN_0025@2,2,2,2"
	 assert range5.getObjectComponent() == "VA012RN_0013@1,1,1,1-VA024RN_0025"
	 assert range6.getObjectComponent() == "VA012RN_0013-VA024RN_0025@2,2,2,2"
	 assert rangeNot1.getObjectComponent() == "VA012RN_0013"
	 assert rangeNot2.getObjectComponent() == "VA012RN_0013"
	 assert rangeNot3.getObjectComponent() == "VA012RN_0013@1.1.1.1"
	 assert rangeNot4.getObjectComponent() == null
	 assert rangeNot5.getObjectComponent() == null
